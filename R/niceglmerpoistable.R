...
#' Lisa's GLMER Poisson Regression Table Function 
#'
#' This function creates a nice looking regression table from a poisson family glmer object 
#' @param df Dataframe. 
#' @param fit GLMER poisson model object.
...
#' @keywords table mixed effects poisson regression glmer   
#' @importFrom xtable xtable
#' @export 
niceglmerpoistable <- function(df, 
                        fit, 
                        covs,
                        intercept = FALSE,
                        ref = FALSE,
